...
public class playsongsofjonyj extends AppCompatActivity {
    //////////////////////////////
    ...
    protected void onStart(){
        ...
        currentSong=JonyJSongs.getSong(currentSongIndex);
        LinearLayout background=(LinearLayout) findViewById(R.id.background);
        background.setBackgroundResource(JonyJSongs.getBackImage(currentSongIndex));
        TextView text=(TextView)findViewById(R.id.songwords);
        text.setText(JonyJSongs.getText(currentSongIndex));
...
////////////////////////////////////////
        ...
        playleftButton.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                order=false;
                Intent intent=new Intent(playsongsofjonyj.this,playsongsofjonyj.class);
                if(currentSongIndex==0){
                    intent.putExtra("currentSongIndex",JonyJSongs.size-1);
                }else{
        ...
        playrightButton.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                order=false;
                Intent intent=new Intent(playsongsofjonyj.this,playsongsofjonyj.class);
                if(currentSongIndex==(JonyJSongs.size-1)){
    ...
    private void startsong(){
        ...
        try {
            ...
            MainActivity.myplayer = MediaPlayer.create(playsongsofjonyj.this, JonyJSongs.getSongSource(currentSongIndex));
            //////////////////////////////////////////////
            CurrentSong.setCurrentSong(currentSong);
            //////////////////////////////////////////////
            MainActivity.myplayer.start();
        }catch (Exception e){
            Toast.makeText(playsongsofjonyj.this,"wrong",Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onBackPressed(){
        Intent intent=new Intent(playsongsofjonyj.this,jonyj.class);
        startActivity(intent);
    }
