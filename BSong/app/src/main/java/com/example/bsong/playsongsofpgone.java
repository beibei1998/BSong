...
public class playsongsofpgone extends AppCompatActivity {
    //////////////////////////////
    ...
    protected void onStart(){
        ...
        currentSong= PgoneSongs.getSong(currentSongIndex);
        LinearLayout background=(LinearLayout) findViewById(R.id.background);
        background.setBackgroundResource(PgoneSongs.getBackImage(currentSongIndex));
        TextView text=(TextView)findViewById(R.id.songwords);
        text.setText(PgoneSongs.getText(currentSongIndex));
...
////////////////////////////////////////
        ...
        playleftButton.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                order=false;
                Intent intent=new Intent(playsongsofpgone.this,playsongsofpgone.class);
                if(currentSongIndex==0){
                    intent.putExtra("currentSongIndex",PgoneSongs.size-1);
                }else{
        ...
        playrightButton.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                order=false;
                Intent intent=new Intent(playsongsofpgone.this,playsongsofpgone.class);
                if(currentSongIndex==(PgoneSongs.size-1)){
    ...
    private void startsong(){
        ...
        try {
            ...
            MainActivity.myplayer = MediaPlayer.create(playsongsofpgone.this, PgoneSongs.getSongSource(currentSongIndex));
            //////////////////////////////////////////////
            CurrentSong.setCurrentSong(currentSong);
            //////////////////////////////////////////////
            MainActivity.myplayer.start();
        }catch (Exception e){
            Toast.makeText(playsongsofpgone.this,"wrong",Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onBackPressed(){
        Intent intent=new Intent(playsongsofpgone.this,pgone.class);
        startActivity(intent);
    }
